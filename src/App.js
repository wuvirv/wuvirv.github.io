...
function App() {
  ...
  const [selected, setSelected] = useState(parseInt(localStorage.getItem('selected')))
  const [isDoc, setisDoc] = useState(() => false)
  const [isnavBox, setisnavBox] = useState(false)
console.log(isDoc);
  if (window.timer) {
  ...
  function appClick(e) {
    if (e.target.className.indexOf('cover')){
      console.log(66);
    }
    console.log(isnavBox);
    setisDoc(!isDoc)
    setisnavBox(!isnavBox)
  }

  return (
    <div className="App" onClick={ (e) => appClick(e) }>
      {/* <video className="liveBgBox" style={{ display: 'block' }} autoPlay loop muted src="https://cdn.jsdelivr.net/gh/MobiusBeta/assets/videos/Live_Wallpaper_2.mp4"></video> */}
      <img className={ isFocus ? 'bgbox foucs' : 'bgbox' } alt="" src="https://cdn.jsdelivr.net/gh/MobiusBeta/assets/images/BG_A_Default_3.jpg"></img>
      <div className="cover" style={{ opacity: 1 }}></div>
      <div className="Time">
        <h1>{ time[0] }<span> : </span>{ time[1] }</h1>
      </div>
      <input className={ isFocus ? 'Search input' : 'Search' } type="text" placeholder="Search" autoComplete="off" size="30"
        onFocus={ e => {
          e.stopPropagation()
      ...
      />
      <div className="engine" style={{ display: isFocus ? 'block' : 'none' }}>
      ...
      <div className="nav_box" style={{display: isDoc ? 'block' : 'none' }}>
        f
      </div>
      <div className="menu">
        <div onMouseDown={ () => {}}>
          <svg className="menu_icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M348.312 667.028c18.082 18.081 46.632 18.081 63.762 0L909.8 169.303c18.082-18.082 18.082-46.632 0-64.714s-46.632-18.082-63.762 0L348.312 602.314c-18.082 18.082-18.082 46.632 0 64.714z"></path><path d="M899.33 443.384c-24.743 0-45.68 19.986-45.68 45.68v364.491h-683.3v-683.3h364.49c24.744 0 44.729-19.986 45.68-45.681 0-24.744-19.985-45.68-44.728-45.68H124.669c-24.743 0-45.68 19.985-45.68 45.68v774.662c0 12.371 4.758 23.792 13.323 32.357 8.565 8.565 19.985 13.323 32.357 13.323h774.662c12.372 0 23.792-4.758 32.357-13.323 8.565-8.565 13.323-19.986 13.323-32.357V489.065c0-25.695-20.937-45.68-45.68-45.68z"></path></svg>
          编辑
        </div>
        <div>
          <svg className="menu_icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M799.2 874.4c0 34.4-28 62.4-62.368 62.4H287.2a62.496 62.496 0 0 1-62.4-62.4V212h574.4v662.4zM349.6 100c0-7.2 5.6-12.8 12.8-12.8h300c7.2 0 12.768 5.6 12.768 12.8v37.6H349.6V100z m636.8 37.6H749.6V100c0-48-39.2-87.2-87.2-87.2h-300a87.392 87.392 0 0 0-87.2 87.2v37.6H37.6C16.8 137.6 0 154.4 0 175.2s16.8 37.6 37.6 37.6h112v661.6A137.6 137.6 0 0 0 287.2 1012h449.6a137.6 137.6 0 0 0 137.6-137.6V212h112c20.8 0 37.6-16.8 37.6-37.6s-16.8-36.8-37.6-36.8zM512 824c20.8 0 37.6-16.8 37.6-37.6v-400c0-20.8-16.768-37.6-37.6-37.6-20.8 0-37.6 16.8-37.6 37.6v400c0 20.8 16.8 37.6 37.6 37.6m-175.2 0c20.8 0 37.6-16.8 37.6-37.6v-400c0-20.8-16.8-37.6-37.6-37.6s-37.6 16.8-37.6 37.6v400c0.8 20.8 17.6 37.6 37.6 37.6m350.4 0c20.8 0 37.632-16.8 37.632-37.6v-400c0-20.8-16.8-37.6-37.632-37.6-20.768 0-37.6 16.8-37.6 37.6v400c0 20.8 16.8 37.6 37.6 37.6"></path></svg>
          删除
        </div>
      </div>
      <div className='setting' style={{transform: isDoc ? 'rotate(60deg)' : 'rotate(0deg)'}} onClick={ ()=> {}}>
        <svg className="setting_icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M881 512c0-52.4 32.9-96.8 79-114.5-11-43.2-28-83.9-50.2-121.3C864.6 296.3 810 288.1 773 251c-37-37-45.2-91.7-25.1-136.8C710.4 92 669.7 75 626.5 64c-17.8 46.1-62.2 79-114.5 79-52.4 0-96.8-32.9-114.5-79-43.2 11-83.9 28-121.3 50.2 20.1 45.2 11.9 99.8-25.1 136.8-37 37-91.7 45.2-136.8 25.2C92 313.6 75 354.3 64 397.5c46.1 17.8 79 62.2 79 114.5 0 52.4-32.9 96.8-79 114.5 11 43.2 28 83.9 50.2 121.3C159.4 727.7 214 735.9 251 773c37 37 45.2 91.7 25.1 136.8C313.6 932 354.3 949 397.5 960c17.8-46.1 62.2-79 114.5-79 52.4 0 96.8 32.9 114.5 79 43.2-11 83.9-28 121.3-50.2-20.1-45.2-11.9-99.8 25.1-136.8 37-37 91.7-45.2 136.8-25.2C932 710.4 949 669.7 960 626.5c-46.1-17.7-79-62.1-79-114.5zM512 635c-67.9 0-123-55.1-123-123s55.1-123 123-123 123 55.1 123 123-55.1 123-123 123z"></path></svg>
      </div>
    </div>
  );
}
