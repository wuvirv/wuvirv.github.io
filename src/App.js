...
function App() {
  ...
  const [isCover, setisCover] = useState(localStorage.getItem('isCover') === 'true' ? true : false)
  ...
  return (
    <div className="App">
      ...
      <div id="cover" className={ isCover ? 'cover' : 'cover Cover'} onClick={ e => {
        if (isFocus) {
          e.stopPropagation();
          setisFocus(false)
      ...
      />
      <div id="isCover" className="isCover" style={{ visibility: isdesk ? 'hidden' : 'visible', opacity: isdesk ? '0' : '1' }} onClick= { (e) => {
        e.stopPropagation();
        setisCover(!isCover)
        localStorage.setItem('isCover', !isCover)
      } }>
        {
          !isCover && <svg className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M512 785.066667a25.6 25.6 0 0 1 25.6 25.6v51.2a25.6 25.6 0 1 1-51.2 0v-51.2A25.6 25.6 0 0 1 512 785.066667z m229.307733-79.9744l36.181334 36.181333a25.6 25.6 0 0 1-36.181334 36.215467l-36.215466-36.181334a25.6 25.6 0 0 1 36.181333-36.215466z m-422.4 0a25.6 25.6 0 0 1 0 36.181333l-36.181333 36.215467a25.6 25.6 0 0 1-36.215467-36.181334l36.181334-36.215466a25.6 25.6 0 0 1 36.215466 0zM861.866667 486.4a25.6 25.6 0 1 1 0 51.2h-51.2a25.6 25.6 0 1 1 0-51.2h51.2z m-648.533334 0a25.6 25.6 0 1 1 0 51.2h-51.2a25.6 25.6 0 1 1 0-51.2h51.2z m564.155734-239.889067a25.6 25.6 0 0 1 0 36.181334l-36.181334 36.215466a25.6 25.6 0 0 1-36.215466-36.181333l36.181333-36.215467a25.6 25.6 0 0 1 36.215467 0z m-494.7968 0l36.215466 36.181334a25.6 25.6 0 1 1-36.181333 36.215466l-36.215467-36.181333a25.6 25.6 0 1 1 36.181334-36.215467zM512 136.533333a25.6 25.6 0 0 1 25.6 25.6v51.2a25.6 25.6 0 1 1-51.2 0v-51.2A25.6 25.6 0 0 1 512 136.533333z"></path><path d="M511.7952 270.7456c-133.051733 0-241.390933 108.270933-241.390933 241.2544 0 132.983467 108.3392 241.2544 241.390933 241.2544 133.0176 0 241.3568-108.270933 241.3568-241.2544 0.1024-132.949333-108.270933-241.2544-241.3568-241.2544z m0 51.2c104.789333 0 190.225067 85.333333 190.1568 190.0544 0 104.686933-85.4016 190.0544-190.1568 190.0544-104.789333 0-190.190933-85.333333-190.190933-190.0544 0-104.686933 85.435733-190.0544 190.190933-190.0544z"></path></svg>
        }
        {
          isCover && <svg className="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M621.2 827.2H285.4c-96.2 0-174.6-78.4-174.6-174.6v-26.8c0-87.8 78.4-165.4 171.4-173.8 24.8-70.8 92-121.6 171.2-121.6s146.6 51 171.2 121.6c93 8.4 171.4 86 171.4 173.8v26.8c0 96.2-78.4 174.6-174.8 174.6zM272.8 493.6c-66.4 12.2-121.8 69.8-121.8 132v26.8c0 74.2 60.2 134.4 134.4 134.4h335.8c74.2 0 134.4-60.2 134.4-134.4v-26.8c0-62.4-55.2-119.8-121.8-132-11.4-2.6-19.8-4.6-41.6-6.2-11.4-66.4-69.4-117-139-117-70.4 0-129 51.8-139.4 119.4-9.2 0-21.2 0.4-41 3.8z"></path><path d="M757.6 566.2c-10.8 1.4-21-5.6-23.6-16.4-2.6-11.4 4.4-23 16-25.6 3.8-0.8 7.6-2 11.4-3 39.6-12.4 72.2-39.6 91.4-76.6 12.6-24 18.4-50.2 17.8-76.4-19.6 16.4-43.6 27.4-69.2 31-75.6 10-145.2-42-156-117.2a134.4 134.4 0 0 1 3.2-52.2c-52 24.2-87.8 76-90 135.8-0.4 11.8-10.2 21-22 20.6-11.8-0.4-21-10.4-20.6-22.2 3.4-95.4 74.6-175 169-189.4 8.6-1.2 17 2.6 21.4 10.2 4.4 7.4 4 16.8-1.2 23.8-14.6 19.6-20.8 43.6-17.6 67.8 7.2 51.4 55 87.8 106.8 80.8 0.4 0 0.6 0 1-0.2 29.2-4.2 55.4-22 69.8-47.8 4.2-7.4 12.2-11.6 20.8-10.8 8.4 0.8 15.6 6.8 18.2 14.8 15.8 50.6 11.2 104.4-13.4 151.4s-66 81.6-116.4 97.6c-4.8 1.6-9.6 2.8-14.4 4-1-0.2-1.8-0.2-2.4 0z"></path></svg>
        }
      </div>
