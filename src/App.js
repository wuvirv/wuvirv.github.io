...
function App() {
  ...
  return (
    <div className="App">
      ...
      <div id="cover" className="cover" style={{ opacity: 1 }} onClick={ e => {
        if (isFocus) {
          e.stopPropagation();
          setisFocus(false)
      ...
      <div id="time" className="Time" onClick={ e => e.stopPropagation() }>
      ...
      <input id="input" className={ isFocus ? 'Search input' : 'Search' } type="text" placeholder="Search" autoComplete="off" size="30"
